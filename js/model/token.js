define('model/token', ['lib/zepto','api/token', 'config/url','lib/makeUrl'],
...
//获得第三方unionid
    ...
    //同过APP返回token 获取用户userid
    //function GetTokenUserObj() {
    //    var GetTokenUserRequestData = {
    //        post: {
    //            token: "?"
    //        }
    //    };
    //    return GetTokenUserRequestData;
    //}

    //function GetTokenUser(dataInfo, callback) {
    //    var bizDataObj = GetTokenUserObj();
    //    var dataInfo = dataInfo || {};
    //    if (dataInfo.post) {
    //        $.merge(bizDataObj.post, dataInfo.post);
    //    };
    //    $.xsr($.makeUrl(apiToken.GetTokenUser, bizDataObj.post), function (res) {
    //        alert('res===', res)
    //        try {
    //            callback && callback(res);
    //        } catch (e) {
